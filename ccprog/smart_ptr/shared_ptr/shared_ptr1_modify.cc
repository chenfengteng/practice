/*
 * This file is a modified version of the file "shared_ptr1.cc",
 * used to validate the reference count of smart_ptr.
 */
...
int main() {
  ...
  *pNico = "Nicolai";
  ...
  // Modify the use_count of object 'pNico'. 
  //pNico(std::nullptr);
  pNico = NULL;
  std::cout << "Nico be used count: " << pNico.use_count() << std::endl;
  std::cout << "Nicolai be used count: " << whoMadeCoffee[2].use_count() << std::endl;
}
